...
1. Add more players with separate key binding and collisions between players.
2. Add obstacles on the canvas with different shapes (rectangles or balls).
3. Make a function for players' registration with a name and displays a table of records.
4. Add the possibility to increase the difficulty by adding balls during the game.
5. Increase or decrease the speed of the ball over time and implement speed controls with keys.
